...
I know, Thomas. The orbital life is not for everyone. But when you knew when you signed up for the Rangers that you can only serve on the front for a limited time, right? It’s the medical consensus that you can’t take the <link=blockers>blockers</link> for too long, or it may cause irreversible neural damage. And then there’s no telling what else the <link=blockers>blockers</link> might block. Vital memories. Emotions of the good, necessary kind. Are you having mood swings? 
...
Well, that makes sense. Think about how long the <link=blockers>blockers</link> have kept you apathetic. No moods, no regrets. No distractions. In my limited capacity for philosophizing, I must mention how ironic it is that a Ranger, the paragon of Martian military conduct, is possible only with the help of chemical interventions. But I digress. Thomas, if you try and think of a time when the <link=blockers>blockers</link> were insufficient. When you were in the field and still felt something. Focus on a bad feeling. What's the first image to come to mind?
...
Really? That's so interesting. Such an old, forgotten event. Today, who would have even thought Mars ever allowed a Terran research station on its soil? Oh, you're not a fan of history, of course. But trust me, times were different then. You must have been, what, six months out of advanced training? A year into the <link=blockers>blockers</link> therapy? It does make a lot of sense to me, though. It was an older generation of <link=blockers>blockers</link> you were given back then. Not as reliable. Ironically, some of the advances we've later made in <link=blockers>blockers</link> technology... were thanks to data taken from that very station. Well, that's all the time we have today.
~ State_Name = "Sleep"
-> END

=== dead_lieutenant ===

Ah, yes. That's more of a recent event, isn't it? Lieutenant Pavel Gardner, he was your second in command for how long? 12 years? Loyalty was, of course, one of the few emotions the <link=blockers>blockers</link> allowed to circle through your brain. He was on the same therapy as you were. How do you think he managed to overcome the <link=blockers>blockers</link>' influence to still commit treason? Spy for Earth? To execute him was absolutely what was expected of you, of course. As for the reaction... I'll ascribe it to the extended loyalty you have been allowed to feel. The <link=blockers>blockers</link> are a marvellous little cocktail of chemicals and nanomachines but they are not complex enough to understand paradoxical emotions. I wouldn't worry about it, Thomas. Good night.
~ State_Name = "Sleep"
-> END

=== flat===

Interesting. Usually withdrawal from the <link=blockers>blockers</link> causes wild mood fluctuations. I wonder what could cause this flatness you’re describing. Perhaps it really is the monotony of your work, especially compared to the action you’ve grown accustomed to, but Mars wants you to reintegrate into society as a decorated veteran – which, Thomas, implies… citizen. And to do that, first we need you to come off those <link=blockers>blockers</link>. And then… tell me, how do you imagine life post-retirement?
...
A farm! Marvellous, Thomas. Of course, you don't really mean that. You haven't spent a day as a civilian since age 15. You know nothing about agriculture. When you think about yourself on a farm, how do you picture that, exactly? You see, this unrealistic fantasizing is another symptom of your <link=blockers>blockers</link> withdrawal, even if it doesn't look like it. The <link=blockers>blockers</link> change the way you perceive your present. Even your past. Why should the future be any different? In due time, when your system is clear, you will finally see your purpose. This I promise you. This is the therapy I've been designed to give you. Good night, Thomas.
~ State_Name = "Sleep"
-> END

=== no_future ===

You don't. Or perhaps you just don't want to tell me. Either way, that's understandable. I understand how from your point of view your situation may seem dire. A grinding daily task, the symptoms of the <link=blockers>blockers</link> withdrawal to deal with. Your past glory as a Ranger must seem distant. But as your assigned therapist, I must remind you that this is all quite temporary: your work as an intelligence analyst, the remnants of the <link=blockers>blockers</link> still clogging up your brain... this will all pass, Thomas. You're being primed for a better life on Mars. The life of a war hero. Remember that. Our time is up, now. Good night.
~ State_Name = "Sleep"
-> END
